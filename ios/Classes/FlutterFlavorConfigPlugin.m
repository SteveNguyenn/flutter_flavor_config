...
@implementation FlutterFlavorConfigPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"flutter_flavor_config"
            binaryMessenger:[registrar messenger]];
  FlutterFlavorConfigPlugin* instance = [[FlutterFlavorConfigPlugin alloc] init];
