...
class FlutterFlavorConfigPlugin(private val context: Context? = null) : FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    ...
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "flutter_flavor_config")
  ...
  private fun loadEnvVariables(): Map<String, Any?> {
    ...
    try {
      ...
      Log.d("FlutterFlavorConfig", "Could not access BuildConfig")
    }
    return variables
  }
}
